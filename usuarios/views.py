...
def logout(request):
    """Faz logof do usuário logado na aplicação"""
    auth.logout(request)
...
def campo_vazio(campo):
    """não libera campos vazios nos campos de cadastro"""
    return not campo.strip()

def senhas_diferentes(senha, confirma_senha):
    """Ajuda a proteger para que os campos senha e confirma senha sejam iguals"""
